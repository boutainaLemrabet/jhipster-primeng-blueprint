    ...
    angularAccountModule: [
        {
            ...
            templates: [
                ...
                { file: 'account/password/password.component.ts' },
                ...
                { file: 'account/password-reset/init/password-reset-init.component.ts' },
                ...
                { file: 'account/password-reset/finish/password-reset-finish.component.ts' },
                ...
                { file: 'account/settings/settings.component.ts' },
        ...
        },
        {
            ...
            templates: [
                ...
                { file: 'account/sessions/sessions.component.ts' },
    ...
    clientTestFw: [
        {
            ...
            templates: ['spec/helpers/mock-table.ts', 'spec/helpers/mock-confirmation.service.ts', 'spec/helpers/mock-translate.service.ts']
        },
        {
            condition: generator => generator.withAdminUi,
            path: ANGULAR_DIR,
